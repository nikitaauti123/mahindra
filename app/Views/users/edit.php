                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="card-title"><?php echo lang('Users.Edit'); ?></h5>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="update_users" method="post" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="row mt-3 mb-3">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" id="password" name="password" autocomplete="off" placeholder="<?php echo lang('Users.Password'); ?>">
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label for="password"><?php echo lang('Users.ConfirmPassword'); ?></label>
